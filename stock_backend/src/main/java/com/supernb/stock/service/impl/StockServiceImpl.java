...
//        PageResult<StockUpdownDomain> pageResult = new PageResult<>(pageInfo);
    ...
    public R<Map<String,List>> getComparedStockTradeAmt() {
        ...
        //3.1 查询T日大盘交易统计数据
        List<Map> data4T=stockMarketIndexInfoMapper.getSumAmtInfo(markedIds,startTime4T,endTime4T);
        //3.2 查询T-1日大盘交易统计数据
        List<Map> data4PreT=stockMarketIndexInfoMapper.getSumAmtInfo(markedIds,startTime4PreT,endTime4PreT);
        //4.组装响应数据
...
//        }
        ...
        //获取指定日期格式的字符串
        mapInfo.put("time",curDateTime.toString("yyyy-MM-dd HH:mm:ss"));
